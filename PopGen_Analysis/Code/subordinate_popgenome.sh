...
python2.7 $star_dir/Code/genomics_general/popgenWindows.py -w $2 -m $3 -s $4 -g $star_dir/Results/PopGenome/${1##*/}.geno.gz -o PopGenome/${1##*/}.csv.gz -f phased -T 5 -p $5 HG00096,HG00097,HG00099 -p $6 HG00100,HG00101,HG00102 -p $7 HG00104,HG00106,HG00108 -p $8 HG00109,HG00110,HG00111 
